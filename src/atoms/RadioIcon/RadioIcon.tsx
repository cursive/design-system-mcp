...
export const RadioIcon: React.FC<RadioIconProps> = ({
    ...
    if (size === 'small' && state === 'unchecked') {
        return (
            <div className={combinedClassName} style={style} data-node-id="5357:44645">
                <svg className="radio-icon__svg" viewBox="0 0 17 17">
                    <path
    ...
    if (size === 'regular' && state === 'checked') {
        return (
            <div className={combinedClassName} style={style} data-node-id="5357:44642">
                <svg className="radio-icon__svg" viewBox="0 0 20 20">
                    <path
                        className="radio-icon__path"
                        clipRule="evenodd"
    ...
    if (size === 'small' && state === 'checked') {
        return (
            <div className={combinedClassName} style={style} data-node-id="5357:44643">
                <svg className="radio-icon__svg" viewBox="0 0 16 16">
                    <path
                        className="radio-icon__path"
                        clipRule="evenodd"
    ...
    return (
        <div className={combinedClassName} style={style} data-node-id="5357:44644">
            <svg className="radio-icon__svg" viewBox="0 0 20 20">
                <path
                    className="radio-icon__path"
