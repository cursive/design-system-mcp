import { j as s } from "../jsx-runtime-11e331e2.mjs";
import "react";
const g = ({
  rating: e = 5,
  maxRating: l = 5,
  ...
  const d = (t) => {
    ...
    return /* @__PURE__ */ s.jsx(
      "button",
      {
        className: `star-rating__star ${n ? "star-rating__star--filled" : "star-rating__star--empty"} ${o ? "star-rating__star--interactive" : ""}`,
        onClick: () => d(r),
        disabled: !o,
        "aria-label": `Rate ${r} out of ${l} stars`,
        type: "button",
        style: { width: a, height: a },
        children: /* @__PURE__ */ s.jsx("svg", { width: a, height: a, viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ s.jsx(
          "path",
          {
            ...
            fill: n ? "var(--color-star-filled)" : "var(--color-star-empty)"
          }
        ) })
      },
      t
  ...
  return /* @__PURE__ */ s.jsx("div", { className: `star-rating ${c}`, role: "img", "aria-label": `${e} out of ${l} stars`, children: Array.from({ length: l }, (t, r) => h(r)) });
};
export {
  g as StarRating
};
